...
\begin{enumerate}
	\item The input data is a finite set of points with some distance or similarity metric. In many cases, including this paper, the distance can be induced by the underlying metric space. Given that our dataset exists in $\mathbb{R}$, the Euclidean space is implied.
...
% How is data represented as a point cloud? 

The standard topological descriptors are the barcode and the persistence diagram, which provide a multiscale representation of the homology of the geometric construction. Homology in degree 0 describes the connectedness of the data; degree 1 detects holes or tunnels; degree 2 captures voids, etc.  \cite{bubenik_2015}. Features that \textit{persist} when the resolution changes are referred to as persistent homology. 

% How are simplicial complexes built on data?  

% What are persistence landscapes? 
